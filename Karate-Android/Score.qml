                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Button {
                            ...
                            Layout.preferredWidth: 1
                            Layout.fillWidth: true
                            onClicked: {if(actualCat1Penalty > 0){--actualCat1Penalty}}
                            enabled: buttonsEnable
                        }
                        ...
                        Button {
                            ...
                            Layout.preferredWidth: 1
                            Layout.fillWidth: true
                            onClicked: {if(actualCat1Penalty< penalty.length -1){++actualCat1Penalty}}
                            enabled: buttonsEnable
                        }
                    ...
                    RowLayout {
                        ...
                        Button {
                            ...
                            Layout.preferredWidth: 1
                            Layout.fillWidth: true
                            onClicked:{if(actualCat2Penalty > 0){--actualCat2Penalty}}
                            enabled: buttonsEnable
                        }
                        ...
                        Button {
                            ...
                            Layout.preferredWidth: 1
                            Layout.fillWidth: true
                            onClicked: {if(actualCat2Penalty< penalty.length -1){++actualCat2Penalty}}
                            enabled: buttonsEnable
                        }
